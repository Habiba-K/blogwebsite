...
export default function BlogCard({post, isDarkBackground}:BlogCardProps)  {
 return(
  ...
  <div className='flex flex-col items-center mt-4'>
    ...
    className={`text-center w-full px-6 py-2 text-white bg-blue-600 rounded hover:bg-blue-500 ${isDarkBackground ? 'bg-black hover:bg-red-500':'bg-black hover:bg-red-500'}`}>
      Read More</a>
  </div>
 </Card>
 );
